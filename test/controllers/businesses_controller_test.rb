...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post businesses_url, params: { business: { city_id: @business.city_id, name: @business.name } }
    end
  ...
  test "should update business" do
    patch business_url(@business), params: { business: { city_id: @business.city_id, name: @business.name } }
